...
- `Splunk4DFIR <https://github.com/mf1d3l/Splunk4DFIR>`_ - Harness the power of Splunk for your investigations.
...
- `Gopher <https://github.com/gdbinit/gopher>`_ - A OS X crypto ransomware PoC.
...
- `Hackers-grep <https://github.com/codypierce/hackers-grep>`_ - A utility to search for strings in PE executables including imports, exports, and debug symbols.
